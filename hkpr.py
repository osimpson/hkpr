...
class Network(object):
    ...
    def get_subgraph(self, subset):
        netxsg = self.graph.subgraph(subset)
        sg = Network(netx=netxsg)
        return sg
...
#     subset = sorted([17,13,31,22,5])
#     print 'subset', subset
#     dSG = dolphins.get_subgraph(subset)
#     t = 15.0
#     eps = 0.001
#     start_node = 17
...
#     print '\n\nUsing the subgraph'
#     print '\texact vector:'
#     true = dSG.exp_hkpr(t, start_node=start_node)
#     print true
#     print 'norm', np.linalg.norm(true, ord=1)
#     print '\tapproximate vector:'
#     appr = dSG.approx_hkpr(t, start_node=start_node, eps=eps, verbose=True)
#     print appr
#     print 'norm', np.linalg.norm(appr, ord=1)
